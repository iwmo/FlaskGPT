function updateSystemMessage(systemMessage) {
  if (
    ...
    systemMessageRef = { role: "system", content: "You are an interpreter that translate any language to English, which make the bot doesn’t chat with you and just straight translation." };
